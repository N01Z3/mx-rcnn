...
def voc_eval(detpath, annopath, imageset_file, classname, annocache, ovthresh=0.5, use_07_metric=False):
    ...
    with open(imageset_file, 'r') as f:
        lines = f.readlines()
    image_filenames = [x.strip().rsplit(".", 1)[0] for x in lines]
    ...
    for image_filename in image_filenames:
        objects = [obj for obj in recs[image_filename] if obj['name'] == classname or obj['name'].lower() == classname]
    ...
    image_ids = [x[0].rsplit(".", 1)[0] for x in splitlines]
